...
<div class="row container border shadow" style="margin: auto; margin-top:3%">
  ...
  <form enctype="multipart/form-data" action = "reg_process.php" method = "POST">
    ...
    <input type="password" class="form-control" name="password" minlength="6" required><br>

    <label class="form-label">Nhập lại mật khẩu:</label>
    <input type="password" class="form-control" name="password2" minlength="6" required><br>
